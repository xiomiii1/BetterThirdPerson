...
const std::array<SignatureDefinition, SignatureCount> definitions{{
    {SignatureId::NormalTick, "? ? ? FC ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? 91 ? ? ? D1 54 D0 3B D5 F3 03 00 AA ? ? ? F9 ? ? ? F8 ? ? ? 39"},
    {SignatureId::GetPerspective, "? ? ? A9 FD 03 00 91 ? ? ? F9 ? ? ? F9 ? ? ? F9 00 01 3F D6 ? ? ? F9 ? ? ? F9 ? ? ? A8 20 00 1F D6 ? ? ? A9 FD 03 00 91"},
    {SignatureId::LocalPlayerApplyTurnDelta, "? ? ? D1 ? ? ? FD ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? A9 ? ? ? 91 56 D0 3B D5 F3 03 00 AA F4 03 01 AA ? ? ? F9 ? ? ? F8 ? ? ? F9 ? ? ? F9"},
    {SignatureId::ClientInstanceGetLocalPlayer, "? ? ? D1 ? ? ? A9 ? ? ? F9 ? ? ? 91 53 D0 3B D5 E8 03 00 AA ? ? ? 91 ? ? ? F9 ? ? ? 91 ? ? ? F8 ? ? ? 95 ? ? ? 91 ? ? ? 95 ? ? ? 36 ? ? ? 91 ? ? ? 52 ? ? ? 94"},
}};
}
bool resolveAll(std::string_view libraryName) {
    ...
    for (const auto& d : definitions) patterns.emplace_back(d.pattern);
