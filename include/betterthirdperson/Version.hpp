...
inline constexpr std::string_view Description =
    "Independent third-person camera rotation and camera-relative movement for Minecraft Bedrock Android.";

inline constexpr std::string_view Version =
    "1.0.1";

inline constexpr std::uint32_t SdkVersion =
    1;

inline constexpr std::string_view RuntimeLibrary =
    "libminecraftpe.so";
